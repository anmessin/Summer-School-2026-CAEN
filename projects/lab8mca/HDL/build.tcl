...
create_project lab8mca $outputDir -part XC7S25CSGA225-1 -force
...
set_property Top top_lab8mca [current_fileset]
...
file copy -force $outputDir/lab8mca.runs/impl_1/top_lab8mca.bin $artDir/top_lab8mca.bin
file copy -force $script_path/RegisterFile.json $artDir/RegisterFile.json

if { [catch { exec rm $artDir/lab8mca.niu  } msg] } {
puts "No niu file present to be deleted"
}

exec zip -j $artDir/lab8mca.niu $artDir/RegisterFile.json $artDir/top_lab8mca.bin $artDir/content.xml
