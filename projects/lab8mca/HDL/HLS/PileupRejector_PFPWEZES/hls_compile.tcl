...
set proj_dir [file dirname [file dirname [file dirname $scriptPath]]]
puts "HLS: tcl path is $proj_dir"
set ip_name "PileupRejector_PFPWEZES"
set source_name "PileupRejector.cpp"
set top_func "PileupRejector"
