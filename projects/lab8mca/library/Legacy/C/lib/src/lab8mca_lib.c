...
SCILIB int REG_T_OFFSET_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_OFFSET, handle);
}
SCILIB int REG_T_OFFSET_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_OFFSET, handle);
}
SCILIB int REG_T_THRS_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_THRS, handle);
}
SCILIB int REG_T_THRS_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_THRS, handle);
}
SCILIB int REG_T_TRIG_K_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_TRIG_K, handle);
}
SCILIB int REG_T_TRIG_K_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_TRIG_K, handle);
}
SCILIB int REG_T_TRIG_M_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_TRIG_M, handle);
}
SCILIB int REG_T_TRIG_M_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_TRIG_M, handle);
}
SCILIB int REG_T_TRAP_K_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_TRAP_K, handle);
}
SCILIB int REG_T_TRAP_K_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_TRAP_K, handle);
}
SCILIB int REG_T_DECONV_M_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_DECONV_M, handle);
}
SCILIB int REG_T_DECONV_M_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_DECONV_M, handle);
}
SCILIB int REG_T_TRAP_GAIN_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_TRAP_GAIN, handle);
}
SCILIB int REG_T_TRAP_GAIN_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_TRAP_GAIN, handle);
}
SCILIB int REG_T_BL_LEN_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_BL_LEN, handle);
}
SCILIB int REG_T_BL_LEN_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_BL_LEN, handle);
}
SCILIB int REG_T_BL_INIB_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_BL_INIB, handle);
}
SCILIB int REG_T_BL_INIB_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_BL_INIB, handle);
}
SCILIB int REG_T_SAMPLE_POS_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_SAMPLE_POS, handle);
}
SCILIB int REG_T_SAMPLE_POS_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_SAMPLE_POS, handle);
}
SCILIB int REG_T_RUN_CFG_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_RUN_CFG, handle);
}
SCILIB int REG_T_RUN_CFG_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_RUN_CFG, handle);
}
SCILIB int REG_T_TRAP_M_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_T_TRAP_M, handle);
}
SCILIB int REG_T_TRAP_M_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_T_TRAP_M, handle);
}
SCILIB int REG_LENGTH_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_LENGTH, handle);
}
SCILIB int REG_LENGTH_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_LENGTH, handle);
}
SCILIB int REG_DLENGTH_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_DLENGTH, handle);
}
SCILIB int REG_DLENGTH_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_DLENGTH, handle);
}
SCILIB int REG_MODE_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_MODE, handle);
}
SCILIB int REG_MODE_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_MODE, handle);
}
...
//-
//- Take as input the downloaded buffer and decode the the different track for each channels. Channel order is the following: [0...2047] Channel 1, [2048...4095] Channel2
//- 
//- 
//-
//- ARGUMENTS:
...
for(int n=0; n< n_ch; n++)
{
	...
	if (current > 0)
    {
        ...
        {
		 read_analog[k + (n_samples*n)] = data_osc[i + (n_samples*n)] & 268435455;
		 ...
		 read_digital3[k + (n_samples*n)] = data_osc[i + (n_samples*n)] >> 30 & 1;
             k++;
        }
