...
SCILIB int REG_INIBIT_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_INIBIT, handle);
}
SCILIB int REG_INIBIT_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_INIBIT, handle);
}
SCILIB int REG_COUNTS_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_COUNTS, handle);
}
SCILIB int REG_COUNTS_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_COUNTS, handle);
}
