...
create_project lab3counter $outputDir -part XC7S25CSGA225-1 -force
...
set_property Top top_lab3counter [current_fileset]
...
file copy -force $outputDir/lab3counter.runs/impl_1/top_lab3counter.bin $artDir/top_lab3counter.bin
file copy -force $script_path/RegisterFile.json $artDir/RegisterFile.json

if { [catch { exec rm $artDir/lab3counter.niu  } msg] } {
puts "No niu file present to be deleted"
}

exec zip -j $artDir/lab3counter.niu $artDir/RegisterFile.json $artDir/top_lab3counter.bin $artDir/content.xml
