...
puts $outfile1 "   </SUPPORTED_PLATFORM>"
puts $outfile1 "   <FPGA>"
puts $outfile1 "       <version>2026.7.23.10</version>"
puts $outfile1 "       <filename>top_lab9exam.bin</filename>"
puts $outfile1 "   </FPGA>"
...
create_project lab9exam $outputDir -part XC7S25CSGA225-1 -force
...
add_files -force ./top_lab9exam.vhd
...
add_files -force ./pcores/TRIGGER_DERIVATIVEp.vhd
...
set_property Top top_lab9exam [current_fileset]
...
file copy -force $outputDir/lab9exam.runs/impl_1/top_lab9exam.bin $artDir/top_lab9exam.bin
file copy -force $script_path/RegisterFile.json $artDir/RegisterFile.json

if { [catch { exec rm $artDir/lab9exam.niu  } msg] } {
puts "No niu file present to be deleted"
}

exec zip -j $artDir/lab9exam.niu $artDir/RegisterFile.json $artDir/top_lab9exam.bin $artDir/content.xml
