...
exec vitis_hls -f HLS/xlx_qdc_UUJHQOSO/hls_compile.tcl >@stdout
...
puts $outfile1 "   </SUPPORTED_PLATFORM>"
puts $outfile1 "   <FPGA>"
puts $outfile1 "       <version>2026.7.21.10</version>"
puts $outfile1 "       <filename>top_da_nominare.bin</filename>"
puts $outfile1 "   </FPGA>"
...
create_project da_nominare $outputDir -part XC7S25CSGA225-1 -force
...
add_files -force ./top_da_nominare.vhd
add_files -force ./HDL/pcores/xlx_qdc_UUJHQOSO.vhd
...
add_files -force ./pcores/sigunsig.vhd
...
add_files -force ./pcores/ZeroFill.vhd
...
set_property Top top_da_nominare [current_fileset]
...
file copy -force $outputDir/da_nominare.runs/impl_1/top_da_nominare.bin $artDir/top_da_nominare.bin
file copy -force $script_path/RegisterFile.json $artDir/RegisterFile.json

if { [catch { exec rm $artDir/da_nominare.niu  } msg] } {
puts "No niu file present to be deleted"
}

exec zip -j $artDir/da_nominare.niu $artDir/RegisterFile.json $artDir/top_da_nominare.bin $artDir/content.xml
