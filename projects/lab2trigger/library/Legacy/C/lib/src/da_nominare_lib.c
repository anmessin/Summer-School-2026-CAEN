...
SCILIB int REG_THRESHOLD_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_THRESHOLD, handle);
}
SCILIB int REG_THRESHOLD_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_THRESHOLD, handle);
}
SCILIB int REG_DELTA_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_DELTA, handle);
}
SCILIB int REG_DELTA_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_DELTA, handle);
}
SCILIB int REG_DE_THRESHOLD_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_DE_THRESHOLD, handle);
}
SCILIB int REG_DE_THRESHOLD_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_DE_THRESHOLD, handle);
}
...
SCILIB int REG_INT_SAMPLES_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_INT_SAMPLES, handle);
}
SCILIB int REG_INT_SAMPLES_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_INT_SAMPLES, handle);
}
SCILIB int REG_PRE_TRIGGER_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_PRE_TRIGGER, handle);
}
SCILIB int REG_PRE_TRIGGER_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_PRE_TRIGGER, handle);
}
...
SCILIB int REG_M_LENGTH_GET(uint32_t *val, NI_HANDLE *handle)
{
     return __abstracted_reg_read(val, SCI_REG_M_LENGTH, handle);
}
SCILIB int REG_M_LENGTH_SET(uint32_t val, NI_HANDLE *handle)
{
     return __abstracted_reg_write(val, SCI_REG_M_LENGTH, handle);
}
