...
puts $outfile1 "   </SUPPORTED_PLATFORM>"
puts $outfile1 "   <FPGA>"
puts $outfile1 "       <version>2026.7.21.1</version>"
puts $outfile1 "       <filename>top_lab1ledlblink.bin</filename>"
puts $outfile1 "   </FPGA>"
...
create_project lab1ledlblink $outputDir -part XC7S25CSGA225-1 -force
...
add_files -force ./top_lab1ledlblink.vhd
...
set_property Top top_lab1ledlblink [current_fileset]
...
file copy -force $outputDir/lab1ledlblink.runs/impl_1/top_lab1ledlblink.bin $artDir/top_lab1ledlblink.bin
file copy -force $script_path/RegisterFile.json $artDir/RegisterFile.json

if { [catch { exec rm $artDir/lab1ledlblink.niu  } msg] } {
puts "No niu file present to be deleted"
}

exec zip -j $artDir/lab1ledlblink.niu $artDir/RegisterFile.json $artDir/top_lab1ledlblink.bin $artDir/content.xml
